...
async def analyze_scan(
    ...
    try:
        ...
        # Stage 1:
        # Identify the card from the supplied photographs.
    ...
    # Ensure we can safely add verification fields.
    identification = dict(identification)
    warnings = []

    # Stage 2:
    # Verify / resolve the AI identification against TCGdex.
    match = None
    ...
    # Stage 3:
    # Use the identification plus TCGdex evidence to perform the
    ...
    condition = dict(assessment.get("condition") or {})
    authenticity = dict(assessment.get("authenticity") or {})
